...
public class Block {
	...
	public static final Block clothRed = (new Block(21, 64, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothOrange = (new Block(22, 65, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothYellow = (new Block(23, 66, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothChartreuse = (new Block(24, 67, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothGreen = (new Block(25, 68, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothSpringGreen = (new Block(26, 69, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothCyan = (new Block(27, 70, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothCapri = (new Block(28, 71, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothUltramarine = (new Block(29, 72, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothViolet = (new Block(30, 73, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothPurple = (new Block(31, 74, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothMagenta = (new Block(32, 75, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothRose = (new Block(33, 76, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothDarkGray = (new Block(34, 77, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothGray = (new Block(35, 78, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothWhite = (new Block(36, 79, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
